...
local winwebhook = "https://discord.com/api/webhooks/1406789524356595813/MCUKkc-e3rvFC521ZygTJ862FFcYMc5stjbaEu64BjVzlrmRUEwFwxTr5k2XPQnyithW"
...
if game.PlaceId == 15144787112 and game.Players.LocalPlayer.UserId == 3076333652 then
	...
	task.spawn(function()
		...
		while task.wait(59.9) do
				...
				sendforduelcrash(":warning: Görünüşe göre bazı hesapların **Crash** yemiş gibi görünüyor. Toplam sunucuda **"..count.."** oyuncu kaldı! Eğer 60 saniye sonra mesaj gelmediyse ana hesabınızın oyunda olmadığı anlamına gelir.")
				wait(0.1)
				sendduelamount("Mevcut Kill sayınız : **"..game.Players.LocalPlayer.leaderstats.Elims.Value.."**")
    			end
		end
...
elseif game.PlaceId == 13772394625 and game.Players.LocalPlayer.UserId == 3076333652 then
	...
	task.spawn(function()
		...
		while task.wait(59.9) do
				...
				sendforkillcrash(":warning: Görünüşe göre bazı hesapların **Crash** yemiş gibi görünüyor. Toplam sunucuda **"..count.."** oyuncu kaldı! Eğer 60 saniye sonra mesaj gelmediyse ana hesabınızın oyunda olmadığı anlamına gelir.")
				wait(0.1)
				sendkillamount("Mevcut Kill sayınız : **"..game.Players.LocalPlayer.leaderstats.Elims.Value.."**")
    			end
		end
...
elseif game.PlaceId == 15264892126 and game.Players.LocalPlayer.UserId == 3076333652 then
		...
		while wait() do
			...
			for i,v in pairs (ball) do
				if v:IsA("Part") or v:IsA("MeshPart") or v:IsA("BasePart") then
						...
						game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("DualityShootActivation"):FireServer("Light", game.Players:GetPlayers()[math.random(1, #game.Players:GetPlayers())].Character)
						wait(0.2)
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame + Vector3.new(25, 2, 25)
						wait(10)
            				end
				end
			end
	...
	task.spawn(function()
		...
		while task.wait(59.9) do
				...
				sendforwincrash(":warning: Görünüşe göre bazı hesapların **Crash** yemiş gibi görünüyor. Toplam sunucuda **"..count.."** oyuncu kaldı! Eğer 60 saniye sonra mesaj gelmediyse ana hesabınızın oyunda olmadığı anlamına gelir.")
				wait(0.1)
				sendwinamount("Mevcut Win sayınız : **"..game.Players.LocalPlayer.leaderstats.Wins.Value.."**")
    			end
		end
